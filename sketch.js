...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    text(" Some asteroids are coming towords our Earth.",canvas.width/2-300, canvas.height/2 - 210);

    text("  You are the only X-wing Starfighter we have  ",canvas.width/2-300,canvas.height/2-170);
    ...
    text("  Use RT and LT arrows to move.",canvas.width/2-300,canvas.height/2-50);
